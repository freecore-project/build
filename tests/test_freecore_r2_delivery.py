...
from artifact_checker_fixture import make_checker
...
class FixtureMixin:
    def setUp(self):
        ...
        checker = make_checker(self.root)
        self.checker_environment = mock.patch.dict(os.environ, {
            "FREECORE_ARTIFACT_CHECKER": str(checker),
        })
        self.checker_environment.start()
        self.addCleanup(self.checker_environment.stop)
